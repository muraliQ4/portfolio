...
const projects = [
  {
    ...
    description: "Developed an anime streaming site using HTML, CSS, JavaScript, and third-party APIs. Includes episode navigation, responsive UI, and video playback.",
    image: "https://images.unsplash.com/photo-1578632767115-351597cf2477?w=800&h=500&fit=crop",
    
    tags: ["HTML", "CSS", "JavaScript", "Third-party APIs", "Responsive Design"],
    demoUrl: "#",
    githubUrl: "#",
    featured: true,
    accentColor: "from-purple-500 to-indigo-600",
    status: "Completed",
    highlights: ["Episode navigation", "Responsive UI", "Video playback"]
  },
  {
    id: 2,
    title: "StudyHub - Engineering Resource Portal",
    category: "Educational Platform",
    description: "Created a centralized resource portal using HTML, JS, and MongoDB to help 100+ students access study materials and tutorials.",
    image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&h=500&fit=crop",
    
    tags: ["HTML", "JavaScript", "MongoDB", "Resource Management"],
    demoUrl: "#",
    githubUrl: "#",
    featured: true,
    accentColor: "from-blue-500 to-cyan-600",
    status: "Live",
    highlights: ["Study materials", "100+ students", "Centralized portal"]
  },
  {
    id: 3,
    title: "Weather Dashboard",
    category: "Web Application",
    description: "Built a real-time weather dashboard with live data and forecasts using JavaScript and OpenWeatherMap API.",
    image: "https://images.unsplash.com/photo-1592210454359-9043f067919b?w=800&h=500&fit=crop",
    
    tags: ["JavaScript", "OpenWeatherMap API", "Real-time Data"],
    demoUrl: "#",
    githubUrl: "#",
    accentColor: "from-amber-500 to-orange-600",
    status: "Completed",
    highlights: ["Live weather data", "Forecast display", "API integration"]
  }
];

const categoryColors = {
  "Web Development": "from-purple-500/20 to-indigo-600/20 text-purple-600 border-purple-500/30",
  "Educational Platform": "from-blue-500/20 to-cyan-600/20 text-blue-600 border-blue-500/30",
  "Web Application": "from-amber-500/20 to-orange-600/20 text-amber-600 border-amber-500/30"
};
        ...
        >
          <div className="bg-background border border-border rounded-2xl p-12 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <motion.a
                href="https://github.com/muraliQ4"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
