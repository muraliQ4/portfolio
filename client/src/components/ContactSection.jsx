  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Please try again or email me directly at sanaboina40170@gmail.com",
        variant: "destructive"
      });
    } finally {
              ...
              <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 hover:bg-accent/30 rounded-lg sm:rounded-xl transition-all duration-300">
                ...
                <div>
                  ...
                  <span className="text-sm sm:text-base font-medium">
                    Khandavalli, Andhra Pradesh, India
                  </span>
                </div>
              </div>
            </div>
                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/murali-sanaboina",
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/muraliQ4",
                  },
                  {
                    icon: Instagram,
                    label: "Instagram",
                    url: "https://www.instagram.com/murali.sanaboina?igsh=NWVxdXF6c3I0eGY0",
                  },
                ].map((social, index) => (
                  <a
                    key={index}
